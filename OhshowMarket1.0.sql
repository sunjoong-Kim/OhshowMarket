...
-- Schema matchmaker
-- -----------------------------------------------------
-- drop database ohshow;

DROP TABLE IF EXISTS ohshow_admin;
DROP TABLE IF EXISTS ohshow_after;
DROP TABLE IF EXISTS ohshow_answer;
DROP TABLE IF EXISTS ohshow_basket;
DROP TABLE IF EXISTS ohshow_basket_detail;
DROP TABLE IF EXISTS ohshow_delivery;
DROP TABLE IF EXISTS ohshow_file;
DROP TABLE IF EXISTS ohshow_maker;
DROP TABLE IF EXISTS ohshow_maker_delivery;
DROP TABLE IF EXISTS ohshow_makerbank;
DROP TABLE IF EXISTS ohshow_notice;
DROP TABLE IF EXISTS ohshow_order;
DROP TABLE IF EXISTS ohshow_order_delivery;
DROP TABLE IF EXISTS ohshow_oreder_detail;
DROP TABLE IF EXISTS ohshow_product;
DROP TABLE IF EXISTS ohshow_qaboard;
DROP TABLE IF EXISTS ohshow_sale_board;
DROP TABLE IF EXISTS ohshow_user;


-- -----------------------------------------------------
-- Schema matchmaker
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS ohshow DEFAULT CHARACTER SET utf8 ;
USE ohshow ;
...
CREATE TABLE `ohshow_sale_board` (
   `sb_id`         INT           NOT NULL COMMENT '판매 게시판', -- 판매 게시판
...
ALTER TABLE `ohshow_sale_board`
   MODIFY COLUMN `sb_id` INT NOT NULL AUTO_INCREMENT COMMENT '판매 게시판';
...
CREATE TABLE `ohshow_qaboard` (
   ...
   `sb_id`            INT          NULL     COMMENT '판매 게시판' -- 판매 게시판
)
COMMENT '제품 문의(Q&A)';
